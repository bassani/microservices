...
@EqualsAndHashCode
@Builder
public class MessageUserNotificationResponse {
    ...
    @ApiModelProperty(value = "Descrição da mensagem", example = "10")
    private String keycloakUserId;

    @ApiModelProperty(value = "Flag status mensagem lida/não lida", example = "false")
